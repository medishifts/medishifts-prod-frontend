...
const Achievements: React.FC = () => {
  ...
  return (
    <section className="flex flex-col mt-20 bg-white dark:bg-black py-10">
      <p
        className="font-semibold text-2xl md:text-3xl text-center text-gray-900 dark:text-white"
        data-aos="fade-up"
      >
        Our Outstanding Achievements
      </p>
      <div className="mt-10 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        {[
          {
            icon: (
              <svg
          ...
          <div
            key={index}
            className="flex flex-col justify-center items-center bg-[#FFF6F3] dark:bg-gray-800 px-4 py-6 rounded-lg"
            data-aos="fade-up"
            data-aos-delay={index * 100} // Stagger animations with a delay
          >
            <div className="flex flex-row items-center">
              {item.icon}
              <p className="font-bold text-2xl sm:text-3xl lg:text-4xl text-primary ml-2">
                {item.value}
              </p>
            </div>
            <p className="font-medium text-base sm:text-lg mt-2 text-center text-gray-900 dark:text-gray-100">
              {item.description}
            </p>
          </div>
        ))}
